...
namespace giococarte
{
    ...
    static class View
    {
        public static string Input()
        {
            ...
            do
            {
                Console.WriteLine("Giocare?S/N");
                s = Console.ReadLine().ToUpper();
            } while (s != "S" && s != "N");
            return s;
        }
        public static void output(Gioco g)
        {
            Console.WriteLine("Carta giocatore:"+g.CartaGiocatore);
            Console.WriteLine("Carta computer:"+g.CartaComputer);
            Console.WriteLine(g.Risultato);
            Console.ReadLine();
        }
        public static string ripeti()
        {
            string s = "";
            do
            {
