...
{
    class derivata: Punto
    {
        string l;
        public derivata(string s)
        {
            l = s;
        }
        public void visualizzader()
        {
            Console.WriteLine(":"+l);
        }
    ...
    class Program
    {
        ...
        {
            derivata p = new derivata("ciao");
            Punto p1 = new Punto();
            p.Setx(Convert.ToInt32(Console.ReadLine()));
            p.Sety(Convert.ToInt32(Console.ReadLine()));
            p.Visualizza();
            p.visualizzader();
